# Business Model: Manufacture of cutlery, hand tools and general hardware
...
## Classification
- Repository: `cloud-itonami-isic-2593` ([github.com/cloud-itonami/cloud-itonami-isic-2593](https://github.com/cloud-itonami/cloud-itonami-isic-2593))
- ISIC Rev.5: `2593` — Manufacture of cutlery, hand tools and general hardware
- Domain: `:cutlery-hand-tools-hardware/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:hardware-shop-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :cutlery-hand-tools-hardware/manufacturing — who wants
...
One managed tenant (:cutlery-hand-tools-hardware/manufacturing):
...
- Do not bypass the `:hardware-shop-plant-operations-governor` for production decisions.
