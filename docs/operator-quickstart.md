# Operator Quickstart — Manufacture of cutlery, hand tools and general hardware

Shortest path from clone to a verified local dry-run for **ISIC 2593** (`cloud-itonami-isic-2593`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2593.git
cd cloud-itonami-isic-2593
```
...
- Blueprint governor key: `hardware-shop-plant-operations-governor`
- Likely source path: `hardwaremfg.governor.cljc`
